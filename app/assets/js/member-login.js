...
function renderVisitorNavMenu() {
  ...
  str = `
  <li><a class="text-gray hover-decoBorder-bottom-gradient position-relative py-2 px-0 ms-8" href="#">生活紀錄</a></li>
  <li><a class="text-gray hover-decoBorder-bottom-gradient position-relative py-2 px-0 ms-8" href="./group-lessons.html">行程規劃</a></li>
  `;
...
function renderLoginRenderNavMenu() {
  ...
  str = `
  <li><a class="text-gray hover-decoBorder-bottom-gradient position-relative py-2 px-0 ms-8" href="./gym-info.html">生活紀錄</a></li>
  <li><a class="text-gray hover-decoBorder-bottom-gradient position-relative py-2 px-0 ms-8" href="./group-lessons.html">行程規劃</a></li>
